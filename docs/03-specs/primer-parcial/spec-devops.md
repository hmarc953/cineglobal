...
Se utilizo el mockup como base para hacer algunas migraciones a bootstrap, como por ejemplo el navbar. Se decidio no agregar el hero section para mantener el estilo de la pagina y por falta de tiempo. 
