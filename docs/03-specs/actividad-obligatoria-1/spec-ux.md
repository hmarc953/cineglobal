...
- Subir la imagen del mockup a la carpeta docs/01-mockup/, específicamente en  docs/01-mockup/actividad-obligatoria-1/diseño-inicial.png, y hacer accesible el archivo Figma vía enlace en el README.md.

Esto se justifica porque el proyecto CineGlobal tiene como objetivo construir una interfaz usable para el aprendizaje del desarrollo web, y la primera entrega requiere documentación y diseño de la interfaz basica.
...
### Mockup
- [x] Imagen en docs/01-mockup/actividad-obligatoria-1/diseño-inicial.png
