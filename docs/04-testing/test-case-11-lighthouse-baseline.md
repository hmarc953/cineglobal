...
El proyecto en su estado actual (rama `develop`, previo a la integración de
fetch/API y de la librería externa) supera holgadamente los 4 umbrales
mínimos definidos para el Segundo Parcial (Performance 97, Accessibility 96,
Best Practices 100, SEO 91). Se detectaron dos hallazgos puntuales y de baja
complejidad —falta de meta description y contraste de color insuficiente—
que se documentan como issues para su corrección, sin que comprometan la
aprobación del baseline. Esta base servirá como punto de comparación para
medir el impacto real de las próximas integraciones de fetch y librería
externa.